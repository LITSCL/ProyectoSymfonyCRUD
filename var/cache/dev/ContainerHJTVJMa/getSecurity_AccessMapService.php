...
class getSecurity_AccessMapService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/tarea-crear'), [0 => 'ROLE_Usuario'], NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/tarea'), [0 => 'ROLE_Usuario'], NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/tarea-editar'), [0 => 'ROLE_Usuario'], NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/mis-tareas'), [0 => 'ROLE_Usuario'], NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/tarea-guardar'), [0 => 'ROLE_Usuario'], NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/tarea-actualizar'), [0 => 'ROLE_Usuario'], NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/tarea-borrar'), [0 => 'ROLE_Usuario'], NULL);
